...
class Senders:
    ...
    def send_some_data_to_redirect():
        ...
        command = client_patterns.command_pattern(
            command_function="retransmit_data", 
            args = {
                "client_to_redirect":"randomsclientids", 
                "data":{"age": 20, "birth": 8, "name": "cristian"}
            }
        )
        ...
        Events_Mananger(Unit="Client1", path="Logs").Set_Event(
            "Correct Data Sended", 
            event_type="Send", 
            event_key="" # TODO >>> Add the event key
        )

        print(result)

    @staticmethod
    def send_some_icorrect_data_to_redirect():
        ...
        command = client_patterns.command_pattern(
            ...
            args = {
                "client_to_redirect":"randomsclientids", 
                "data":{"age": 5, "birth": 5, "name": "potato"}
            }
        )
